...
namespace NexxtDent.Models
{
    public class Income
    {
        ...
        [Display(ResourceType = typeof(Resource), Name = "Income_Model_Origen")]
        public string Source { get; set; }

        [Required(ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = "Required")]
        [MaxLength(10, ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = "MaxLength")]
        [Display(ResourceType = typeof(Resource), Name = "Income_BillingNoteControl")]
        ...
        [Display(ResourceType = typeof(Resource), Name = "Income_Model_Monto")]
